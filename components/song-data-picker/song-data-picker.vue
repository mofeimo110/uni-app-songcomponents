<template>
	<view class="uni-data-tree">
		...
		<view class="uni-data-tree-dialog" v-if="isOpened">
			...
			<view class="dialog-caption" v-if="openSearch">
				<view style="width: 80%; margin: 10px 10%;">
					<uni-easyinput type="text" suffixIcon="search" v-model="searchWord" placeholder="输入关键字搜索"
						@iconClick="searchBegin" @confirm="searchBegin" @input="inputSearchBegin"></uni-easyinput>
				</view>
			</view>
			...
			<data-picker-view v-show="!showSearchResult" class="picker-view" ref="pickerView" v-model="value"
				...
				:managed-mode="true" @change="onchange" @datachange="ondatachange"></data-picker-view>
		</view>
	</view>
</template>
		...
		methods: {
			...
			searchBegin() {
				...
				if (this.searchFn && this.searchFn instanceof Function) {
					this.searchResult = this.searchFn(this.searchDatas, this.searchWord)
				} else {
